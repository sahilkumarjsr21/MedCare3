...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNoReminderView = (TextView) findViewById(R.id.text);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public VerticalItemHolder onCreateViewHolder(ViewGroup container, int viewType) {
            ...
            View root = inflater.inflate(R.layout.list_item_recycle, container, false);
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                mDateAndTimeText = (TextView) itemView.findViewById(R.id.date_time);
                mRepeatInfoText = (TextView) itemView.findViewById(R.id.repeatType);
                mActiveImage = (ImageView) itemView.findViewById(R.id.bell);
                mThumbnailImage = (ImageView) itemView.findViewById(R.id.thumbnail);
            }
            ...
            public void setActiveImage(String active){
                if(active.equals("true")){
                    mActiveImage.setImageResource(R.drawable.ic_notifications_active_24dp);
                }else if (active.equals("false")) {
                    mActiveImage.setImageResource(R.drawable.ic_notifications_off_24dp);
                }
            }
        }
